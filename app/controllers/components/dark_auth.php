...
class DarkAuthComponent extends Object {
  ...
  var $group_model_name = 'Rank'; //Group for access control if used, if not used please set to an empty string. NB: DON'T CALL requiresAuth with Groups if no group model. it will error.
  ...
  var $session_secure_key = 'ssade33VStkedAdlxaasdBy'; //some random stuff that someone is unlikey to guess.
